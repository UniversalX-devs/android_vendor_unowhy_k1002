...
CUSTOM_KERNEL_IMGSENSOR = hm5040_mipi_raw gc2355_mipi_raw gc5035_mipi_raw gc2375h_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = WG10118602881CB_k1002_dsi_vdo_tps65132
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dw9714_gc5035af dummy_lens
...
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714_gc5035af
CUSTOM_KERNEL_MAIN_IMGSENSOR = hm5040_mipi_raw
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = gc2375h_mipi_raw
...
CUSTOM_LK_LCM = WG10118602881CB_k1002_dsi_vdo_tps65132
CUSTOM_MODEM =
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = WG10118602881CB_k1002_dsi_vdo_tps65132
...
SPEAK_USE_AUDIO_CHANNEL_SUPPORT = yes
...
#Disable CTA for CTS test, xmwyq, 20190131
MTK_CTA_SET = no
MTK_CTA_SUPPORT = no
...
MTK_TABLET_HARDWARE = mt8167
MTK_TABLET_PLATFORM = MT8167
MTK_TABLET_PLUGIN_BUILD = no
MTK_TABLET_TS_ENHANCEMENT = yes
...
MTK_PRODUCT_LINE_PLATFORM = MT8167
...
#disable MTK AB system update ,xmlyz,20190510
...
MTK_TABLET_EMMC_ACTIVE_BOOT_PART = yes
MTK_CAM_BGSERVICE_SUPPORT = yes
MTK_VOW_BARGE_IN_SUPPORT = no
MTK_GPU_VERSION = rgx clark 1.10ED
MTK_HDMI_HIDL_SUPPORT = no
MTK_SIMPLE_LAUNCHER_SUPPORT = no
MTK_LITE_PROJECT = no
MTK_AUDIO_PCM_MERGE_SUPPORT = no
#Add GMS apks accord by gms version, if no need GMS apks, don't include this config
GMS_VERSION=9_201907
MTK_SOUNDRECORDER_APP=yes
#Add AFW default, xmly, 201890305
